...
exp_name=fgvc_vit_supervised_${LR}_${target_ratio}_${WEIGHT_DECAY}_${low_rank_dim}_${batch_size}
...
python train_alloc_ema.py --data-path=./data/fgvc/${DATASET} --init_thres=${init_thres} \
 ...
 --beta1=${beta1} --beta2=${beta2} --metric ipt --model-ema --model-ema-decay=0.9999 \
