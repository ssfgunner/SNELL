...
exp_name=vtab_vit_supervised_${LR}_${init_thres}_${WEIGHT_DECAY}_${low_rank_dim}_${batch_size}_200
python train.py --data-path=./vtab-1k/${DATASET} --init_thres=${init_thres} \
