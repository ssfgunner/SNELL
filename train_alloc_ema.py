    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch % args.val_interval == 0 or epoch >= args.epochs-10:  # Evaluate more in the last a few epochs
            ...
            if max_accuracy_ema < test_stats_ema['acc1']:
                best_model_ema = copy.deepcopy(model_ema)
            ...
            print(
                f"[{args.exp_name}] Max EMA accuracy on the {args.data_set} dataset {len(dataset_val)} with ({args.opt}, {args.lr}, {args.weight_decay}), {max_accuracy_ema:.2f}%")
